...
config :phx_demo, PhxDemoWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "e1PO3nE6/u3a5jl4fFaOSgSkdF7A7DahiFpHjQDgQSHlwPgUC3Z6vx9BC6qXwnTr",
  watchers: [
...
config :phx_demo, PhxDemoWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/phx_demo_web/router\.ex$"E,
      ~r"lib/phx_demo_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]
